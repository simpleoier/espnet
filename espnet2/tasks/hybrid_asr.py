...
from espnet2.train.preprocessor import PhonemePreprocessor_multi
...
class ASRTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ESPnetHybridASRModel),
    ...
    def build_preprocess_fn(
        ...
        if args.use_preprocessor:
            retval = PhonemePreprocessor_multi(
                train=train,
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetHybridASRModel:
        ...
        # 6. RNN-T Decoder (Not implemented)
        rnnt_decoder = None
